...
def cosineSimilarity():
	...
	lowercaseQuery1 = singularize(lowercaseQuery)
	print(lowercaseQuery1)
	queryWordList = re.sub("[^\w]", " ",lowercaseQuery1).split()			#Replace punctuation by space and split
	...
	database2 = singularize(database1)
	print(database2)
	...
	output = "Idea matches %0.02f%% with database."%matchPercentage
